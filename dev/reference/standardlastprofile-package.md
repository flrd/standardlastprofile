...
second interface generates daily standard load profiles for gas using
the synthetic 'SigLinDe' method. More information on the data and
methodology for electricity is described in "Standardlastprofile Strom",

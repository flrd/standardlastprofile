...
Use the optional `holidays` argument to supply your own vector of ISO 8601 dates that should be treated as public holidays. When provided, the built-in holiday data are ignored entirely, giving you full control over which dates count as holidays.

...
days alone. Consequently, the values provided in the `slp` dataset for `H0`,
`H25`, `P25`, and `S25` are primarily mathematical auxiliary values intended
for multiplication with a dynamization factor.
...
H0_2026_daily <- by(H0_2026, INDICES = format(H0_2026$start_time, "%j"), FUN = function(x) {
  data.frame(

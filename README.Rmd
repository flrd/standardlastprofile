...
The dataset contains 9,504 observations of 5 variables. Given a day, a period and a profile the data in `load_profiles` represents a 'typical day', e.g. a Sunday in winter versus a workday in summer. There are 11 load profiles for 3 customer groups:

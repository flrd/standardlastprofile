...
## About the data
The standardlastprofile package contains one dataset called `slp`. In total
...
Please note that this project is released with a [Contributor Code of Conduct](https://github.com/flrd/standardlastprofile/blob/master/conduct.md). 

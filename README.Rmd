...
- `slp_info()` -- function for retrieving details of standard load profiles
...
ggplot(G5, aes(start_time, watts)) +
  ...
  NULL
```
For more information, details about the data, and an explanation of the algorithm, refer to the vignette [`vignette("algorithm-step-by-step", package = "standardlastprofile")`](https://flrd.github.io/standardlastprofile/articles/algorithm-step-by-step.html).

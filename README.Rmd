...
There are 11 different `profile`s in total, call `get_load_profile_info()` for more information[^bdew-1].
...
See [`vignette("algorithm-step-by-step", package = "standardlastprofile")`](https://flrd.github.io/standardlastprofile/articles/algorithm-step-by-step.html) for a detailed explanation of the algorithm[^bdew-2].

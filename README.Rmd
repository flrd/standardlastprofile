...
- `slp_generate()` --	Interface to generate a standard load profile, normalized to an annual consumption of 1,000 kWh
- `slp_info()` -- Retrieve information and examples of BDEW standard load profiles

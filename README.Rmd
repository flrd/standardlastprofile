...
In contrast to most commercial and agricultural businesses, which have a relatively even consumption and a fairly constant power consumption within the three periods, households on the other hand have a continuously decreasing load from winter to summer and vice versa. This is taken into account by applying a dynamization function (4th order polynomial), see [bdew.de](https://www.bdew.de/media/documents/1999_Repraesentative-VDEW-Lastprofile.pdf), page 32/46.

...
and gas published by the German Association of Energy and Water
...
BDEW/VKU/GEODE synthetic 'SigLinDe' procedure from daily temperatures
and a customer value ('Kundenwert'). The 1999 data and methodology are
...
Strom", <https://www.bdew.de/energie/standardlastprofile-strom/>. The
gas procedure is described in BDEW (2025), "Standardlastprofile Gas",
...
**Maintainer**: Markus Döring <m4rkus.doering@gmail.com> \[copyright
holder\]

Authors:

- Markus Döring <m4rkus.doering@gmail.com> \[copyright holder\]

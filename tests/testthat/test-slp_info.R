DE <- list(
  ...
  G1 = list(
    profile = "G1", description = "Gewerbe werktags 8-18 Uhr",
  ...
  G2 = list(
    profile = "G2", description = "Gewerbe mit starkem bis überwiegendem Verbrauch in den Abendstunde",
  ...
  G3 = list(
    profile = "G3", description = "Gewerbe durchlaufend",
  ...
  G4 = list(
    profile = "G4", description = "Laden/ Friseur",
  ...
  G5 = list(
    profile = "G5", description = "Bäckerei mit Backstube",
  ...
  G6 = list(
    profile = "G6", description = "Wochenendbetrieb",
  ...
  L0 = list(
    profile = "L0", description = "Landwirtschaftsbetriebe allgemein",
  ...
  L1 = list(
    profile = "L1", description = "Landwirtschaftsbetriebe mit Milchwirtschaft/ Nebenerwerbs-Tierzucht",
  ...
  L2 = list(
    profile = "L2", description = "Übrige Landwirtschaftsbetriebe",
...
EN <- list(
  ...
  G0 = list(
    profile = "G0", description = "commerce in general",
  ...
  G1 = list(
    profile = "G1", description = "commerce workday from 8am - 6pm",
  ...
  G2 = list(
    profile = "G2", description = "commerce with predominant consumption in evening hours",
    details = "This profile mainly includes illumination-intensive electricity consumption. Such businesses are characterised by a rather subordinate daily demand on working days (especially in the winter season) and a consumption focus in the evening hours. These include, for example, petrol stations and stores with a large display window area, also evening restaurants and leisure facilities, as long as their consumption focus is not on weekends, e.g. fitness and tanning studios, youth centres (see also G6)."
  ),
  G3 = list(
    profile = "G3", description = "commerce continous",
  ...
  G4 = list(
    profile = "G4", description = "shop / barbershop",
    details = "These are consumers that are almost exclusively characterised by store opening hours (workday until the evening, on Saturday until the afternoon). This is the typical profile for stores of all kinds. Hairdressers also have a similar profile. Differences due to e.g. individual afternoons without business operations are hardly significant in relation to the overall group. Store opening hours, some of which are extended to 8 p.m., also have little influence, as the effects of business operations are mixed with those of evening store lighting."
  ),
  G5 = list(
    profile = "G5", description = "bakery with bakehouse",
  ...
  G6 = list(
    profile = "G6", description = "weekend business",
    details = "Commercial facilities with a clear focus on consumption at weekends. In particular, these are all businesses characterised by the leisure activities of the population: youth clubs, restaurants and cafés, petrol stations with car washes, cinemas with food outlets, sports and leisure facilities."
  ),
  L0 = list(
    profile = "L0", description = "agricultural in general",
  ...
  L1 = list(
    profile = "L1", description = "agricultural with dairy farming / part-time livestock farming",
    details = "The electricity consumption of dairy farms is characterised by the double milking and subsequent cooling of the milk. Part-time farms with e.g. pig rearing show similar behaviour: Here, electricity consumption is triggered in the early morning and evening (before and after the main farm respectively) by the feeding processes. In the case of large main farms with animal husbandry, such processes are distributed over the classic working hours, so that the appropriate commercial profile must be selected."
  ),
  L2 = list(
    profile = "L2", description = "other agricultural businesses",

DE <- list(
  ...
  G1 = list(
    profile = "G1",
    description = "Gewerbe werktags 8-18 Uhr",
  ...
  G2 = list(
    profile = "G2",
    description = "Gewerbe mit starkem bis überwiegendem Verbrauch in den Abendstunde",
  ...
  G3 = list(
    profile = "G3",
    description = "Gewerbe durchlaufend",
  ...
  G5 = list(
    profile = "G5",
    description = "Bäckerei mit Backstube",
  ...
  L0 = list(
    profile = "L0",
    description = "Landwirtschaftsbetriebe allgemein",
  ...
  L1 = list(
    profile = "L1",
    description = "Landwirtschaftsbetriebe mit Milchwirtschaft/ Nebenerwerbs-Tierzucht",
  ...
  L2 = list(
    profile = "L2",
    description = "Übrige Landwirtschaftsbetriebe",
...
EN <- list(
  ...
  G0 = list(
    profile = "G0",
    description = "commerce in general",
  ...
  G1 = list(
    profile = "G1",
    description = "commerce workday from 8am - 6pm",
  ...
  G2 = list(
    profile = "G2",
    description = "commerce with predominant consumption in evening hours",
  ...
  G3 = list(
    profile = "G3",
    description = "commerce continous",
  ...
  G5 = list(
    profile = "G5",
    description = "bakery with bakehouse",
  ...
  L0 = list(
    profile = "L0",
    description = "agricultural in general",
  ...
  L1 = list(
    profile = "L1",
    description = "agricultural with dairy farming / part-time livestock farming",
  ...
  L2 = list(
    profile = "L2",
    description = "other agricultural businesses",

...
#'
#' @examples
#' get_profile_information(language = "english")
#' get_profile_information(language = "german")
get_profile_information <- function(language = c("english", "german")) {
  ...
  data.frame(
    profile = factor(profiles, levels = profiles),
